...
import com.example.carpoolbuddy.otherRec.myCarAdapter;
import com.example.carpoolbuddy.otherRec.myRideAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(myRides.this, menuActivity.class);
